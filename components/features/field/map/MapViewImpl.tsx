...
import { MapControls } from '@/components/features/field/map/MapControls';
import type { VenueMapPoint } from '@/components/features/field/map/venue-marker-dialog';
import type { ICourtWithSport } from '@/lib/api/types';
import { formatVenueAddress } from '@/lib/utils/format';
...
export function MapViewImpl({
  ...
  return (
    <MapContainer center={defaultCenter} zoom={13} className="h-full w-full" scrollWheelZoom>
      ...
      {userLocation ? (
        <FitUserAndVenuesBounds userLocation={userLocation} venues={venuePoints} />
      ) : null}
