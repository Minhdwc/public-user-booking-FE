...
export function ChatPageContent() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid min-h-96 gap-4 lg:grid-cols-[auto_1fr]">
        <div className="overflow-hidden rounded-xl border border-border/70 bg-card lg:w-64">
          {isLoading ? (
...
export const VenueChatButton = ({
  ...
  return (
    <Button className={className} onClick={handleClick} disabled={startConversation.isPending}>
      <MessageCircle className="size-4" />
      {startConversation.isPending ? 'Đang kết nối...' : label}
    </Button>
  );
};
