  ...
  return (
    <form onSubmit={handleSubmit} className="relative w-full max-w-3xl">
      <div className="flex items-center gap-2 rounded-2xl border border-emerald-500/30 bg-card/95 p-2 shadow-2xl backdrop-blur-xl transition-all duration-200 focus-within:border-emerald-500/60 focus-within:ring-4 focus-within:ring-emerald-500/10">
        ...
        <Button
          type="submit"
          className="h-auto rounded-xl bg-emerald-600 px-6 sm:px-8 py-3 text-sm md:text-base font-bold text-white shadow-lg shadow-emerald-600/25 hover:bg-emerald-500 active:scale-95 transition-all duration-200 shrink-0 cursor-pointer text-nowrap min-h-[46px]"
        >
...
function HeroBackground() {
  return (
    <>
      ...
      <div
        className="absolute -top-24 -right-12 size-[28rem] rounded-full bg-emerald-500/10 blur-3xl"
        aria-hidden
      />
      <div
        className="absolute bottom-0 left-1/4 size-[22rem] rounded-full bg-teal-400/10 blur-3xl"
        aria-hidden
      />
      <div
      ...
      <div className="relative mx-auto size-full py-8">
          ...
          <div className="mt-4 grid grid-cols-3 gap-2">
            {[
              ...
              >
                ...
                <p className="text-[11px] font-semibold text-emerald-600 dark:text-emerald-400">{slot.price}</p>
                <span className="mt-1 block text-[9px] font-medium text-muted-foreground">{slot.status}</span>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="glass-card absolute -bottom-2 -left-6 z-20 flex items-center gap-3 rounded-2xl border border-white/40 p-3 shadow-xl backdrop-blur-md">
          ...
          <div>
            ...
            <p className="text-[10px] text-muted-foreground">Giữ sân thành công 100%</p>
          </div>
        </div>
        ...
        <div className="glass-card absolute -top-2 right-0 z-20 flex items-center gap-3 rounded-2xl border border-white/40 p-3 shadow-xl backdrop-blur-md">
          ...
          <div>
            ...
            <p className="text-[10px] text-muted-foreground">Thanh toán QR nhanh gọn</p>
          </div>
        </div>
      </div>
    </div>
          ...
          <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
            <div>
              ...
              <p className="mt-5 max-w-xl text-base md:text-lg text-muted-foreground leading-relaxed">
                Tìm kiếm sân cầu lông, pickleball, bóng đá, tennis gần bạn. So sánh giá khung giờ trống và giữ chỗ tức thì 24/7.
              </p>
      ...
      <PageShell className="pt-12">
        <div className="mb-10">
          <div className="mb-4 flex items-center justify-between">
            ...
            <Link href="/courts" className="text-xs font-semibold text-emerald-600 dark:text-emerald-400 hover:underline flex items-center gap-1">
        ...
        {recentlyViewedQuery.data && recentlyViewedQuery.data.length > 0 ? (
          <div className="mb-14">
            <div className="mb-6 flex items-center justify-between">
              <div>
                <h2 className="text-xl md:text-2xl font-bold tracking-tight text-foreground">Đã xem gần đây</h2>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="max-w-xl text-center md:text-left">
              ...
              <p className="mt-3 text-emerald-100 text-sm md:text-base leading-relaxed">
                Đăng ký hợp tác ngay để quản lý lịch sân hiệu quả, gia tăng doanh thu và tiếp cận hàng ngàn khách hàng đặt sân mỗi ngày.
              </p>
            </div>
            <Button
              asChild
